...
protocol AddItemDetailViewControllerDelegate:class {
    ...
    func AddItemDetailerController(_ controller:EditItemViewController,didFinishAdding item:Item)
...
class EditItemViewController: UIViewController {
    ...
    @IBAction func done(){
        if let item = ItemtoEdit {
            ...
            delegate?.EditItemDetailerController(self, didFinishEditing: item)
        }
        else {
    ...
    @IBAction func cancel(){
        delegate?.ItemDetailerViewControllerDidCancel(self)
    }
